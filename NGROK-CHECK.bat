...
curl -o "C:\Users\Public\Desktop\ublock_origin-1.40.8-an%2Bfx.xpi" https://raw.githubusercontent.com/ealeech/ngrok/main/ublock_origin-1.40.8-an%2Bfx.xpi > out.txt 2>&1
